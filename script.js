...
// Need a reference of my "canvas" by using its id
const canvas = document.getElementById('canvas');
/* obtain a "context". Without the "context", I can't draw on canvas */
...
/* for moving Paddles */
// add my eventListener to browser window
window.addEventListener('keydown', keyDownHandler);
window.addEventListener('keyup', keyUpHandler);

// This gets activated when we press down a key
...
// it gets activated when we release the key
...
// reset the ball
function reset() {
  // this function resets ball's value to older values
...
// the render function will draw everything to the canvas
function render() {
  // set a style
  ctx.fillStyle = "#000"; /* stuff below this gets the black color (#000). */
...
// should call gameLoop() function 30 times per second
